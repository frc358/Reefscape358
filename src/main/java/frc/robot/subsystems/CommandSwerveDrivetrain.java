...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
     ...
     public void configureAutoBuilder() {
        try {
            ...
            AutoBuilder.configure(
                () -> stateCache.Pose,   // Supplier of current robot pose
                this::resetPose,         // Consumer for seeding pose against auto
                () -> stateCache.Speeds, // Supplier of current robot speeds
    ...
    public void periodic() {
         ...
         */
        if (!m_hasAppliedOperatorPerspective && Robot.obtainedAlliance){
            setOperatorPerspectiveForward(Robot.isRedAlliance() ? kRedAlliancePerspectiveRotation : kBlueAlliancePerspectiveRotation);
  ...
  public Command pathFindToSetup() {
    return new DeferredCommand(
            () -> {
              ...
              return AutoBuilder.pathfindToPose(closestPose, AutoConstants.slowPathConstraints, 0);
            },
            Set.of(this))
